...
import {IRequest, ILoginRequest, IRequestUpdateUser} from "../../interfaces/request";
...
export default class UserController {
  ...
  public async createUser(request: IRequestUpdateUser, h: Hapi.ResponseToolkit) {
    try {

     // const isAdmin: boolean = await this.checkForAdmin(request);
     // if (!isAdmin) {
     //   Boom.forbidden('You are not an admin');
     // }
  ...
  public async updateUser(request: IRequestUpdateUser, h: Hapi.ResponseToolkit) {
